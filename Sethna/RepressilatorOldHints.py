...
class Repressilator:
    ...
    system introduced by Elowitz and Leibler, Nature 403, 335-338 (2000).
    All reactions in the stochastic version of the Repressilator
    are implemented, with rate constants as given in the paper.
    ...
    def __init__(self,
        ...
        self.rates = scipy.zeros(len(self.reactions), scipy.Float)
    ...
    def GetStateVector(self):
        c = scipy.zeros(len(self.chemIndex), scipy.Float)        
...
def Animate(trajectory):
    ...
    animator = Animation.RepressilatorAnimator()
